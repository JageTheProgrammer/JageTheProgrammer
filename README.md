...
<!-- ===================================================== -->
<!--  GitHub Profile README | Jaakko Maatiala              -->
  ...
  <svg width="100%" height="260" viewBox="0 0 1200 260" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="animatedGradient" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stop-color="#0a1cff">
          <animate attributeName="stop-color" values="#0a1cff;#0066ff;#00c6ff;#0a1cff" dur="10s" repeatCount="indefinite" />
        </stop>
        <stop offset="100%" stop-color="#00c6ff">
          <animate attributeName="stop-color" values="#00c6ff;#0a1cff;#0066ff;#00c6ff" dur="10s" repeatCount="indefinite" />
        </stop>
      </linearGradient>
    </defs>

    <rect width="1200" height="260" rx="24" fill="url(#animatedGradient)" />

    <text x="50%" y="42%" text-anchor="middle"
          fill="#ffffff" font-size="50"
    ...
    <text x="50%" y="60%" text-anchor="middle"
          fill="#eaf6ff" font-size="22"
          font-family="Segoe UI, Arial, sans-serif">
      Web Developer · Technical Architect · maatiala.online
    </text>

    <text x="50%" y="75%" text-anchor="middle"
          fill="#cfeaff" font-size="16"
          font-family="Segoe UI, Arial, sans-serif">
      Modern Web · Real-time Systems · Performance-first Development
    </text>
  </svg>
</p>
